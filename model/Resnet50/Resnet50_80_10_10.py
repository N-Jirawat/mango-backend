...
report_dir = rf'C:\Users\Asus\OneDrive\เอกสาร\Report_Model\ResNet50\ResNet50_80_R10_{timestamp_dir}'
...
# Map CLAHE + ResNet50 preprocess → แล้ว prefetch (ไม่มี augmentation)
...
# สามารถปรับเพิ่มลดจำนวน layer ได้ เช่น base_model.layers[:-30]
for layer in base_model.layers[:-20]: # Unfreeze 20 layers สุดท้ายของ ResNet50
...
final_model_path = rf'C:\Users\Asus\OneDrive\เอกสาร\Model\ResNet50\model_resnet50_80_R10_{timestamp_dir}.keras'
