...
# เริ่มบันทึกรายงาน
log_and_print("="*80)
log_and_print("🚀 VGG16 Training Report")
log_and_print(f"📅 Start Time: {training_start_datetime.strftime('%Y-%m-%d %H:%M:%S')}")
log_and_print("="*80)

# ----------------------------
# ฟังก์ชันช่วยเหลือ: CLAHE + VGG16 Preprocessing
# ----------------------------
...
# Map CLAHE + VGG16 preprocess → แล้ว prefetch
...
# ----------------------------
# สร้างโมเดล VGG16 พร้อม mixed precision
# ----------------------------
